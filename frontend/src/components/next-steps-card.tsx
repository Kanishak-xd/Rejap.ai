    ...
    return (
        <Card className="mt-8 border-2 shadow-lg overflow-hidden">
            ...
            <CardContent className="space-y-6">
                ...
                <div className="bg-primary/5 border border-primary/10 rounded-xl p-5 relative">
                    <Sparkles className="w-5 h-5 text-primary absolute -top-2.5 -left-2.5 bg-background rounded-full p-0.5" />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {levelPromoted ? (
                        <Button asChild size="lg" className="w-full gap-2 bg-yellow-600 hover:bg-yellow-700">
                        ...
                        <Button onClick={onRetry} size="lg" className="w-full gap-2">
