...
export default function LevelComplete() {
    ...
    return (
        <div className="container mx-auto px-4 py-16 max-w-2xl text-center">
            ...
            <h1 className="text-5xl font-black mb-4 bg-gradient-to-r from-yellow-600 to-orange-600 bg-clip-text text-transparent">
                Level Mastered!
            </h1>
                ...
                <CardContent className="pt-8 space-y-8">
                    <div className="grid grid-cols-2 gap-8">
                        <div className="space-y-2">
                            ...
                            <div className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Completion</div>
                        </div>
                        <div className="space-y-2">
                            <div className="text-4xl font-black text-green-600">80%+</div>
                            <div className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Average Score</div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-center gap-4 py-4">
                        <div className="flex -space-x-2">
                            {[1, 2, 3, 4, 5].map((i) => (
                                <div key={i} className="w-10 h-10 rounded-full bg-yellow-400 border-2 border-white flex items-center justify-center shadow-sm">
                                    <Star className="w-5 h-5 text-white fill-current" />
                                </div>
                            ))}
                        </div>
                        <span className="font-bold text-yellow-700">Perfect Mastery!</span>
                    </div>
                </CardContent>
            </Card>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                {nextLevel ? (
                    <Button asChild size="lg" className="w-full sm:w-auto px-12 py-8 text-xl font-bold rounded-2xl shadow-xl hover:scale-105 transition-transform gap-3">
                ...
                <Button asChild variant="outline" size="lg" className="w-full sm:w-auto px-12 py-8 text-xl font-bold rounded-2xl border-2">
                    <Link to="/">Back to Home</Link>
                </Button>
            </div>
        </div>
